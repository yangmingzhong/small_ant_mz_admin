<?php /*a:2:{s:27:"theme/usermanage\index.html";i:1594353516;s:24:"theme/public\header.html";i:1594284627;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <div class="layuimini-main">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" placeholder='<?php echo lang("USERNAME_OR_EMAIL"); ?>' autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <?php if((btnAuth('Usermanage/addAdminUser'))): ?>
...
<script>
    layui.use(['form', 'util', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '<?php echo url("Usermanage/index"); ?>',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'role_txt', width: 150, title: '<?php echo lang("ENABLED_STATUS"); ?>'},
                {field: 'create_time', width: 200, title: '<?php echo lang("ADD_TIME"); ?>',templet: function (d) {
                        return util.toDateString(d.create_time);
                    }},
                {field: 'last_login_time', width: 200, title: '<?php echo lang("LAST_LOGIN_TIME"); ?>'},
                {field: 'update_time', width: 200, title: '<?php echo lang("UPDATE_TIME"); ?>',templet: function (d) {
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '<?php echo url("Usermanage/addAdminUser"); ?>',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '<?php echo url("Usermanage/editAdminUser"); ?>?id='+data.aid,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('<?php echo lang("DELETE_CONFIRM_MESSAGE"); ?>', function (index) {
                    $.post('<?php echo url("Usermanage/delAdminUser"); ?>', data, function (res) {
                        if(200 == res.code) {
                ...
                layer.confirm('<?php echo lang("BLOCK_USER_CONFIRM_MESSAGE"); ?>', function (index) {
                    $.post('<?php echo url("Usermanage/statusAdminUser"); ?>', data, function (res) {
                        if(200 == res.code) {

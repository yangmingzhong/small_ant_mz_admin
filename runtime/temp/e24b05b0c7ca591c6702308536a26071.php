<?php /*a:2:{s:23:"theme/article\edit.html";i:1594267132;s:24:"theme/public\header.html";i:1594284627;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="title" lay-verify="required" lay-reqtext="<?php echo lang('TITLE_NOTEMPTY'); ?>" placeholder="<?php echo lang('TITLE_INPUT'); ?>" value="<?php echo htmlentities($save_data['title']); ?>" class="layui-input">
            <tip></tip>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="subtitle"  placeholder="<?php echo lang('SUBTITLE_INPUT'); ?>" value="<?php echo htmlentities($save_data['subtitle']); ?>" class="layui-input">
            <tip></tip>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" id="upload_img">
             <?php if($save_data['img_url']): ?>
            <div >
                <a href="<?php echo htmlentities($save_data['img_url']); ?>" target="_blank"><img src="<?php echo htmlentities($save_data['img_url']); ?>" class="upload-down-img"></a>
                <div class="upload-down-img-delete layui-icon layui-icon-delete" onclick="clearImgData(this)"></div>
                <input type="hidden" name="img_url"  value="<?php echo htmlentities($save_data['img_url']); ?>">
            </div>
            <?php endif; ?>
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" id="upload_imgs">
            <?php if(!empty($save_data['imgs_url_arr'])): foreach($save_data['imgs_url_arr'] as $key=>$val): ?>
            <div style="display: inline-block">
                <a href="<?php echo htmlentities($val); ?>" target="_blank"><img src="<?php echo htmlentities($val); ?>" class="upload-down-img"></a>
                <div class="upload-down-img-delete layui-icon layui-icon-delete" onclick="clearImgData(this)"></div>
                <input type="hidden" name="imgs_url_a[]"  value="<?php echo htmlentities($val); ?>">
            </div>
            <?php endforeach; ?>
            <?php endif; ?>
        </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            ...
            <textarea name="content" id="content"  class="layui-textarea" placeholder="<?php echo lang('CONTENT_INPUT'); ?>" style="display: none"><?php echo htmlentities($save_data['content']); ?></textarea>
        </div>
    </div>
    <input type="hidden" name="id" value="<?php echo htmlentities($save_data['id']); ?>">
    <div class="layui-form-item">
        <div class="layui-input-block">
        ...
        var uploadInst = upload.render({
            ...
            multiple:Multiple,
                ...
                if(res.code ==  0){ //存入作用域
                    if(Multiple == false) {
                        var html = ' <div >\n' +
                            ' <img src="'+res.data.src+'" class="upload-down-img">\n' +
                            '  <div class="upload-down-img-delete layui-icon layui-icon-delete" onclick="clearImgData(this)"></div>\n' +
...
<script>
    ...
    //添加连接
    var Save_Url_Form = '<?php echo url("Article/edit"); ?>';

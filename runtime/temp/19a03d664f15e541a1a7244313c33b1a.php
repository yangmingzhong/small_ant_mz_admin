<?php /*a:2:{s:21:"theme/role\index.html";i:1594353663;s:24:"theme/public\header.html";i:1594284627;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="layuimini-container">
    <div class="layuimini-main">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="username" placeholder='<?php echo lang("ROLE_NAME"); ?>' autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        <script type="text/html" id="currentTableBar">
            {{#  if(d.role_id != 1){ }}
                    <?php if((btnAuth('role/edit'))): ?>
                    <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="edit"><?php echo lang('EDIT'); ?></a>
                    <?php endif; if((btnAuth('role/roleSetting'))): ?>
                    <a class="layui-btn layui-btn-normal layui-btn-xs layui-btn-success" lay-event="role_setting"><?php echo lang('ROLE_SETTING'); ?></a>
                    <?php endif; if((btnAuth('role/delete'))): ?>
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'role_name', width: 150, title: '<?php echo lang("ROLE_NAME"); ?>'},
                {field: 'status', width: 150, title: '<?php echo lang("ENABLED_STATUS"); ?>','templet':'#statusTxt'},
                {field: 'remarks', width: 800, title: '<?php echo lang("DESCRIPTION"); ?>'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '<?php echo url("role/edit"); ?>?id='+data.role_id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('<?php echo lang("DELETE_CONFIRM_MESSAGE"); ?>', function (index) {
                    $.post('<?php echo url("role/delete"); ?>', data, function (res) {
                        if(200 == res.code) {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['40%', '80%'],
                    content: '<?php echo url("role/roleSetting"); ?>?role_id='+data.role_id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('<?php echo lang("BLOCK_USER_CONFIRM_MESSAGE"); ?>', function (index) {
                    $.post('<?php echo url("role/statusRole"); ?>', data, function (res) {
                        if(200 == res.code) {

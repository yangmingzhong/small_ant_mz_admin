<?php /*a:2:{s:20:"theme/role\edit.html";i:1594022199;s:24:"theme/public\header.html";i:1594284627;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="role_name" lay-verify="required" lay-reqtext="<?php echo lang('ROLE_NAME_NOTEMPTY'); ?>" placeholder="<?php echo lang('ROLE_NAME_INPUT'); ?>" value="<?php echo htmlentities($role_data['role_name']); ?>" class="layui-input">
            <tip></tip>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="status" value="1" title="<?php echo lang('ENABLED'); ?>" <?php if($role_data['status']==1): ?>checked<?php endif; ?> >
            <input type="radio" name="status" value="0" title="<?php echo lang('DISABLED'); ?>" <?php if($role_data['status']==0): ?>checked<?php endif; ?> >
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="remarks" class="layui-textarea" placeholder="<?php echo lang('REMARK_MESS_INPUT'); ?>"><?php echo htmlentities($role_data['remarks']); ?></textarea>
        </div>
    </div>
    <input type="hidden" name="role_id" value="<?php echo htmlentities($role_data['role_id']); ?>">
    <div class="layui-form-item">
        <div class="layui-input-block">
...
<script>
    //添加连接
    var Save_Url_Form = '<?php echo url("role/edit"); ?>';
</script>

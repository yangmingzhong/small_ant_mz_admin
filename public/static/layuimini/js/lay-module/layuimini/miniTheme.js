        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<span> Colour Combination</span>\n' +
                    '</div>\n' +
                    '<div class="color-content">\n' +
                    '<ul>\n' + bgColorHtml + '</ul>\n' +
                    '</div>\n' +
                    '<div class="more-menu-list">\n' +
                    '<a class="more-menu-item" href="https://github.com/yangmingzhong/small_ant_mz_admin" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> gitHub Open Source Address </a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
